...
Google-Serienvorkommnisse können einzeln oder als vollständige Serie bearbeitet und gelöscht werden. Beim **Bearbeiten** bietet OpenCalendar zusätzlich **Diesen und alle folgenden Termine** an. Dabei wird die bestehende Google-Serie am gewählten Vorkommnis geteilt: Der vordere Serienteil bleibt unverändert, ab dem gewählten Termin entsteht ein neuer Serienteil mit den Änderungen. Bereits vorhandene Ausnahmen ab diesem Termin werden dabei zurückgesetzt. Beim Löschen stehen weiterhin **Nur diesen Termin** und **Gesamte Serie** zur Verfügung. Microsoft- und CalDAV-Serienvorkommnisse werden weiterhin nur lesend dargestellt.
