...
assertSymconStrict(
    str_contains($viewSource, 'use IPSViewStyleConfigurationHelper;')
    ...
    'The calendar view must use IPSViewStyleConfigurationHelper for the standalone IPSView style.'
);
assertSymconStrict(
