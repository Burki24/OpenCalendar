...
assertTrueValue(
    is_string($viewModuleSource)
        ...
        && str_contains($viewModuleSource, '$expectedToken = $this->ipsViewToken();')
        && str_contains($viewModuleSource, "\$expectedToken === str_repeat('0', 32)")
        && str_contains($viewModuleSource, 'hash_equals($expectedToken, $token)')
        ...
        && str_contains($viewModuleSource, "header('Access-Control-Allow-Origin: ' . \$origin);")
        && str_contains($viewModuleSource, "\$origin !== 'null'")
        && str_contains($viewModuleSource, "\$origin !== 'file://'")
