...
final class MicrosoftTodoTaskProjection
{
    ...
    /**
     * Parses the provider timestamp for both projection and date-only edit round trips.
     *
     * @param array<string, mixed> $value
     */
    public static function dateTime(array $value): ?DateTimeImmutable
    {
    ...
    {
        $sourceDate = self::dateTime($value);
        if ($sourceDate === null) {
            return null;
        }
        try {
